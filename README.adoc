...
= Sistema Bancário para Testes com JUnit 5  image:https://img.shields.io/github/workflow/status/Flaviogomes1/sistemabancario4/Pacote%20Maven[GitHub Workflow Status]
im  age:  https://img.shields.io/github/workflow/status/Flaviogomes1/sistemabancario4/Pacote%20Maven[GitHub Workflow Status]
